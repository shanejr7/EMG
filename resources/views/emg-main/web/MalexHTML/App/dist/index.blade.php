                ...
                <div class="d-flex justify-content-center align-items-center h-100">
                    <div class="loading-content">
                        <div class="logo logo-primary">
                            <img class="animated zoomin" src="assets/img/logo/IMG_1326.svg" alt="Logo">
                        </div>
                    </div>
                </div>
            </div>
...
<!-- 
                            <div class="icon-list">
                                <div class="icon-list-items">
                                    <div class="icon-list-item">
                                        <p><span class="d-flex"><i class="fas fa-check"></i><span>Constant Improvement</span></span></p>
                                    </div>

                                    <div class="icon-list-item">
                                        <p><span class="d-flex"><i class="fas fa-check"></i><span>Commitment to Customers</span></span></p>
                                    </div>

                                    <div class="icon-list-item">
                                        <p><span class="d-flex"><i class="fas fa-check"></i><span>Best Quality You Can Get</span></span></p>
                                    </div>
                   ...
                   <!--  <div id="video" class="block">
                    ...
                    <!-- <section id="testimonials" class="block bg-dark spacer p-top-xl p-bottom-xl">
                        <div class="wrapper">
                            ...
                            <div class="description text-tertiary">
                                <h2>Our Happy Customers Reviews</h2>
                            </div>

                            <div class="adv-slider-reviews text-tertiary">
                                ...
                                <div class="d-flex align-items-center thumbs">
                                    <div class="adv-swiper-container reviews-thumbs">
                                        <div class="adv-swiper-wrapper reviews-thumbs-items">
                                            <div class="adv-swiper-slide reviews-thumbs-item" data-reviews-name="Tommy Andersen" data-reviews-position="CEO at Company">
                                                <img src="assets/img/placeholder/60x60.jpg" alt="Tommy Andersen">
                                            </div>

                                            <div class="adv-swiper-slide reviews-thumbs-item" data-reviews-name="Arthur Hopin" data-reviews-position="CEO at Company">
                                                <img src="assets/img/placeholder/60x60.jpg" alt="Arthur Hopin">
                                            </div>

                                            <div class="adv-swiper-slide reviews-thumbs-item" data-reviews-name="Rosie Ford" data-reviews-position="CEO at Company">
                                    ...
                                    <div class="reviews-results">
                                        <h6 class="reviews-name" id="reviews-name">Tommy Andersen</h6>
                                        <p class="reviews-positions" id="reviews-positions">CEO at Company</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row gutter-width-md with-pb-md spacer p-top-lg">
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                        <div class="card card-post">
                                            ...
                                            <div class="card-body">
                                                <h5 class="card-title">
                                                    <a title="5 Tips for Sustainable Business Success" href="news-single-post.html">5 Tips for Sustainable Business Success</a>
                                                </h5>

                                                <p class="card-text">At vero eos et accusamus et iusto odio dignissimos ducims…</p>

                                                <div class="card-btn">
                                                    <a title="Read more" class="btn btn-sm btn-link btn-icon-hover p-0 border-0 min-w-auto link-no-space text-uppercase" href="news-single-post.html">
                                                        <i class="malex-icon-arrow-right i-large"></i>
                                                        <span class="btn-text">Read more</span>
                                                    </a>
                                                </div>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                        <div class="card card-post">
                                            <div class="card-top position-relative">
                                                <a title="Assessing the Maturity of Your Data Management in Industry" href="news-single-post.html">
                                                    <div class="img object-fit overflow-hidden">
                                                        <div class="object-fit-cover transform-scale-h">
                                            ...
                                            <div class="card-body">
                                                <h5 class="card-title">
                                                    <a title="Assessing the Maturity of Your Data Management in Industry" href="news-single-post.html">Assessing the Maturity of Your Data Management in Industry</a>
                                                </h5>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                        <div class="card card-post">
                                            <div class="card-top position-relative">
                                                <a title="How to Build Your Sustainable Susiness Strategy" href="news-single-post.html">
                                                    <div class="img object-fit overflow-hidden">
                                                        <div class="object-fit-cover transform-scale-h">
                                            ...
                                            <div class="card-body">
                                                <h5 class="card-title">
                                                    <a title="How to Build Your Sustainable Susiness Strategy" href="news-single-post.html">How to Build Your Sustainable Susiness Strategy</a>
                                                </h5>
 ...
 -->
                                    ...
                                    <!--     <form method="post" action="form.php" id="cf-1" class="contact-form">
                                            ...
                                            <div class="form-group form-group-xs">
                                                <input name="cf-1-email" type="email" class="form-control form-control-lg bg-gray-light" id="cf-1-email" placeholder="Email" required="required">
                                            </div>

                                            <div class="form-group form-group-xs">
                                                <textarea name="cf-1-message" class="form-control form-control-lg bg-gray-light" id="cf-1-message" placeholder="Message" required="required"></textarea>
                                            </div>
