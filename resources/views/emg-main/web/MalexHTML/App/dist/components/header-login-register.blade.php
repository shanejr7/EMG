                        ...
                        <div class="d-flex align-items-center">
                            <div class="menu">
                                <nav class="menu-primary">
                                    <ul class="nav">
                                        <li class="nav-item">
                                            <a title="Services" id="color" href="/#services" style="color:black">What We Do</a>
                                        </li>

                                        <li class="nav-item">
                                            <a title="About Us" style="color:black" href="/#about-us">Who We Are</a>
                                        </li>

                                        <li class="nav-item">
                                            <a title="Contacts" style="color:black" href="/#contacts">Contacts</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
