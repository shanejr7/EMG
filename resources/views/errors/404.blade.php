...
<html lang="en-US">
    <head>
        ...
        <title>404 | EMG - Business Consulting Agency</title>
    ...
    <body class="error404 title-opacity-true">
     <!--    <div class="loading">
        ...
        <main id="main" class="site-main">
            <div id="page-title">
                <div class="wrapper">
                    <div class="title">
                        <h1 class="large">404 Error</h1>
                    </div>

                    <div class="title-opacity">
                        <div class="title-opacity-text">404</div>
                    </div>
                </div>
            </div><!-- #page-title -->
            ...
            <div id="page-content" class="spacer p-top-lg">
                <div class="wrapper">
                    <div class="content">
                        <p class="text after">The page you were looking for couldn't be found.</p>
                       ...
                       <!--  <div class="form">
                        ...
                        <div class="button">
                            <a title="Back to Home" class="btn btn-outline-secondary" href="/">Back to Home</a>
                        </div>
                    </div>
                </div>
            </div><!-- #page-content -->
