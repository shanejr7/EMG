        ...
        for (let x = 0; x < numOfDependents; x++) {
          ...
          $("#healthInsurance2").on("click", function(){
            ...
            if($("#healthInsurance2").is(":checked") == true){
                ...
                $('.insuredDependents').append('<div class="row form-group" id="selectedDepdendentsMonth_'+index+'"> <div class="form-check form-check-inline"> <input class="form-check-input" type="checkbox" id="inlineCheckboxJanuary'+index+'" value="January" name="months_insured_january[]"> <label class="form-check-label" for="inlineCheckboxJanuary'+index+'">January</label> </div> <div class="form-check form-check-inline"> <input class="form-check-input" type="checkbox" id="inlineCheckboxFebuary'+index+'" value="Febuary" name="months_insured_febuary[]"> <label class="form-check-label" for="inlineCheckboxFebuary'+index+'">Febuary</label> </div> <div class="form-check form-check-inline"> <input class="form-check-input" type="checkbox" id="inlineCheckboxMarch'+index+'" value="March" name="months_insured_march[]"> <label class="form-check-label" for="inlineCheckboxMarch'+index+'">March</label> </div> <div class="form-check form-check-inline"> <input class="form-check-input" type="checkbox" id="inlineCheckboxApril'+index+'" value="April" name="months_insured_april[]"> <label class="form-check-label" for="inlineCheckboxApril'+index+'">April</label> </div> <div class="form-check form-check-inline"> <input class="form-check-input" type="checkbox" id="inlineCheckboxMay'+index+'" value="May" name="months_insured_may[]"> <label class="form-check-label" for="inlineCheckboxMay'+index+'">May</label> </div> <div class="form-check form-check-inline"> <input class="form-check-input" type="checkbox" id="inlineCheckboxJune'+index+'" value="June" name="months_insured_june[]"> <label class="form-check-label" for="inlineCheckboxJune'+index+'">June</label> </div> <div class="form-check form-check-inline"> <input class="form-check-input" type="checkbox" id="inlineCheckboxJuly'+index+'" value="July" name="months_insured_july[]"> <label class="form-check-label" for="inlineCheckboxJuly'+index+'">July</label> </div> <div class="form-check form-check-inline"> <input class="form-check-input" type="checkbox" id="inlineCheckboxAugust'+index+'" value="August" name="months_insured_august[]"> <label class="form-check-label" for="inlineCheckboxAugust'+index+'">August</label> </div> <div class="form-check form-check-inline"> <input class="form-check-input" type="checkbox" id="inlineCheckboxSeptember'+index+'" value="September" name="months_insured_september[]"> <label class="form-check-label" for="inlineCheckboxSeptember'+index+'">September</label> </div> <div class="form-check form-check-inline"> <input class="form-check-input" type="checkbox" id="inlineCheckboxOctober'+index+'" value="October" name="months_insured_october[]"> <label class="form-check-label" for="inlineCheckboxOctober'+index+'">October</label> </div> <div class="form-check form-check-inline"> <input class="form-check-input" type="checkbox" id="inlineCheckboxNovember'+index+'" value="November" name="months_insured_november[]"> <label class="form-check-label" for="inlineCheckboxNovember'+index+'">November</label> </div> <div class="form-check form-check-inline"> <input class="form-check-input" type="checkbox" id="inlineCheckboxDecember'+index+'" value="December" name="months_insured_december[]"> <label class="form-check-label" for="inlineCheckboxDecember'+index+'">December</label> </div> </div>');

                for(let i =1; i < numOfDependents; i++){

                  $('.insuredDependents').append('<div class="row form-group" id="selectedDepdendentsMonth_'+i+'"> <div class="form-check form-check-inline"> <input class="form-check-input" type="checkbox" id="inlineCheckboxJanuary'+i+'" value="January" name="months_insured_january[]"> <label class="form-check-label" for="inlineCheckboxJanuary'+i+'">January</label> </div> <div class="form-check form-check-inline"> <input class="form-check-input" type="checkbox" id="inlineCheckboxFebuary'+i+'" value="Febuary" name="months_insured_febuary[]"> <label class="form-check-label" for="inlineCheckboxFebuary'+i+'">Febuary</label> </div> <div class="form-check form-check-inline"> <input class="form-check-input" type="checkbox" id="inlineCheckboxMarch'+i+'" value="March" name="months_insured_march[]"> <label class="form-check-label" for="inlineCheckboxMarch'+i+'">March</label> </div> <div class="form-check form-check-inline"> <input class="form-check-input" type="checkbox" id="inlineCheckboxApril'+i+'" value="April" name="months_insured_april[]"> <label class="form-check-label" for="inlineCheckboxApril'+i+'">April</label> </div> <div class="form-check form-check-inline"> <input class="form-check-input" type="checkbox" id="inlineCheckboxMay'+i+'" value="May" name="months_insured_may[]"> <label class="form-check-label" for="inlineCheckboxMay'+i+'">May</label> </div> <div class="form-check form-check-inline"> <input class="form-check-input" type="checkbox" id="inlineCheckboxJune'+i+'" value="June" name="months_insured_june[]"> <label class="form-check-label" for="inlineCheckboxJune'+i+'">June</label> </div> <div class="form-check form-check-inline"> <input class="form-check-input" type="checkbox" id="inlineCheckboxJuly'+i+'" value="July" name="months_insured_july[]"> <label class="form-check-label" for="inlineCheckboxJuly'+i+'">July</label> </div> <div class="form-check form-check-inline"> <input class="form-check-input" type="checkbox" id="inlineCheckboxAugust'+i+'" value="August" name="months_insured_august[]"> <label class="form-check-label" for="inlineCheckboxAugust'+i+'">August</label> </div> <div class="form-check form-check-inline"> <input class="form-check-input" type="checkbox" id="inlineCheckboxSeptember'+i+'" value="September" name="months_insured_september[]"> <label class="form-check-label" for="inlineCheckboxSeptember'+i+'">September</label> </div> <div class="form-check form-check-inline"> <input class="form-check-input" type="checkbox" id="inlineCheckboxOctober'+i+'" value="October" name="months_insured_october[]"> <label class="form-check-label" for="inlineCheckboxOctober'+i+'">October</label> </div> <div class="form-check form-check-inline"> <input class="form-check-input" type="checkbox" id="inlineCheckboxNovember'+i+'" value="November" name="months_insured_november[]"> <label class="form-check-label" for="inlineCheckboxNovember'+i+'">November</label> </div> <div class="form-check form-check-inline"> <input class="form-check-input" type="checkbox" id="inlineCheckboxDecember'+i+'" value="December" name="months_insured_december[]"> <label class="form-check-label" for="inlineCheckboxDecember'+i+'">December</label> </div> </div>');
